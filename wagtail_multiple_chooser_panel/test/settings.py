...
INSTALLED_APPS = [
    ...
    "wagtail_multiple_chooser_panel.test",
...
ROOT_URLCONF = "wagtail_multiple_chooser_panel.test.urls"
...
DATABASES = {
    "default": dj_database_url.config(default="sqlite:///test_wagtail_multiple_chooser_panel.db"),
}
...
WAGTAIL_SITE_NAME = "Wagtail Multiple Chooser Panel test site"
